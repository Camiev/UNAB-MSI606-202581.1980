...
El código completo del proyecto, incluyendo el notebook de Jupyter con todas las etapas de preprocesamiento, entrenamiento y evaluación del modelo, está disponible públicamente en: \url{https://github.com/Camiev/UNAB-MSI606-202581.1980/blob/main/proyecto1.ipynb}
...
El código fuente completo de este proyecto, incluyendo el notebook de Jupyter con todas las etapas de preprocesamiento, ingeniería de features, entrenamiento del modelo XGBoost y evaluación, está disponible públicamente en GitHub: \url{https://github.com/Camiev/UNAB-MSI606-202581.1980/blob/main/proyecto1.ipynb}
